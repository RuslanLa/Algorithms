...
public class Mixing
{
    ...
    {
        var firstDict = CountLetters(s1);
        var secondDict = CountLetters(s2);
    ...
    private static IEnumerable<Occurrence> MixOccurencies(Dictionary<char, int> first, Dictionary<char, int> second)
    {
